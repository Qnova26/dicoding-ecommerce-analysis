...
# --- Data Validation & Dashboard Output ---
st.header('E-Commerce Public Dashboard ✨')

if main_df.empty:
    st.warning("⚠️ Tidak ada data untuk rentang waktu dan kategori yang dipilih. Silakan sesuaikan filter Anda.")
else:
    ...
    with tab3:
        ...
        with col3:
            avg_monetary_rfm = format_currency(rfm_df.monetary.mean(), "BRL", locale='pt_BR')
            st.metric("Avg. Monetary", value=avg_monetary_rfm)
